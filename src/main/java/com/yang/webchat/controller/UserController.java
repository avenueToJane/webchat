...
import com.yang.webchat.service.IUserService;
import com.yang.webchat.utils.*;
...
public class UserController {
    ...
    public ModelAndView user(@PathVariable("userid") String userid, @ModelAttribute("userid") String sessionid){
        ModelAndView view = new ModelAndView("infoSelf");
        user = userService.selectUserByUserid(userid);
        view.addObject("user", user);
        return view;
    }
